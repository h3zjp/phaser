...
**Related skills files:** scenes.md, events-system.md
...
The `DataManagerPlugin` removes its shutdown listener on shutdown but does NOT clear data on shutdown. Data persists if the scene restarts. It only fully resets on scene destroy.
